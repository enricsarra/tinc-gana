export const receptes = [
    {
    nombre: `Filet de gall dindi ("solomillo")a la mostassa`,
  ...
  {
    nombre: `Mandonguilles & Sipia`,
    bio: `Un plat molt bó i paciencia. Temps aproximat 1h 30'`,
  ...
  {
    nombre: `Callos amb cigrons`,
    bio: `Es un plat de cassola.`,
  ...
  {
    nombre: `Cuixetes de guatlles`,
    bio: `Les cuixetes son de Juneda i utilitzo una creusset blava`,
  ...
  {
    nombre: `Guatlles al forn`,
    bio: `Les guatlles son de Juneda`,
  ...
  {
    nombre: `Llenties amb cua de bou`,
    bio: `Un plat que encara no he trobat el punt. Utilitzo la cassola negra amb tapa transparent.`,
    ingredientes: ` 1/2 llenties naturals; Cua de bou; 1 ceba sencera pelada; 4 alls sencers sense pelar; 1 cullerada farina; 1 cullerada postres pebre vermell dolç; 1 cullerada postres pebre vermell picant `,
  ...
  {
    nombre: `Amanida de llenties i arròs`,
    bio: `Es un plat per desengrassar.`,
  ...
  {
    nombre: `Fricandó amb bolets`,
    bio: `Ingredients per 4 persones....nyam nyam nyam...`,
    ingredientes: `1 quilo de vedella ECO del Pedraforca tallada fina;
    75 grams de moixernons de Bernau;550 grams d’aigua tèbia; 1 ceba picada; 2 tomàquets madurs triturats; 1 bon raig de brandi; 100 grams de vi blanc; 2 alls; Fulles de julivert; Un grapat d’ametlles; Dues galetes Maria; Farina, oli i sal `,
    elaboracion: `Un plat molt tradicional i per gaudir en dinars familiars. Primerament, posarem els moixernons a remull en l’aigua tèbia. Mentre es remullen, salpimentem la vedella. Després la passem per la farina.;
    Després, afegim oli en una cassola i fregim els talls de vedella fins que es daurin pels dos costats. Quan estiguin fets ho reservem.;
    Una vegada ho tenim, passem al sofregit. En la mateixa cassola, traiem l’excés de farina i col·loquem la ceba picada i cou-la durant 20 minuts. Després, afegim el tomàquet triturat i continuem coent uns 15 minuts més. Ha de quedar ben sofregit i confitat. Afegim el brandi i que s’evapori.;
    A continuació, afegim la carn de vedella a la cassola amb el sofregit. Colem l’aigua dels moixernons, i els afegim també a la cassola. Tirem el raig de vi blanc i l’aigua colada dels bolets per cobrir tota la carn. Afegeix les espècies que vulguis.;
    Tapa la cassola i deixa coure a foc lent durant una horeta. Anem remenant sovint perquè la carn no s’enganxi.;
  ...
  {
    nombre: `Butifarra amb bolets(rovellons)`,
    bio: `Tipical botifarra`,
  ...
  },
  {
    ...
    bio: `Plat rápid i per menjar a continuació`,
    ingredientes: ` Llobarro; Alls; Bitxo; Julivert; Pebre vermell; Mantega; Oli d'oliva; Vinagre`,
    // tslint:disable-next-line: max-line-length
  ...
  {
    nombre: `Espinacs snack`,
    bio: ` Per aperitiu uns bons espinacs`,
    ingredientes: ` fulles espinacs; oli; comino; sal i pebre; `,
    // tslint:disable-next-line: max-line-length
  ...
  {
    nombre: `Rovellons`,
    bio: ` Rovellons a la catalana per a 6 persones.` ,
    ingredientes: ` 600 gr de rovellons (Rovellons); Un all trossejat fi;  Una branqueta de romaní (opcional);  4 cullerades soperes d'oli d'oliva
      sal maldon;  2 cullerada sopera de julivert trossejat `,
    elaboracion: ` 1 Netejar els bolets amb un drap humit o amb un pinzell.;
    2 Si les rentem absorbeixen molta aigua i a l'saltar-desprenen aigua i es bullen més que es rosteixen.;
    3 Preparar una picada amb l'all, l'oli, el julivert i una mica de romaní (opcional).;
    4  Posar sal al fons de la paella i una mica d'oli.;
    5  Posar els bolets i anar-voltejant. Quan gairebé estiguin a punt, tirar la barreja d'oli amb all i julivert, fins que l'all es dauri. Servir calents.;
  ...
  {
    nombre: `Pollastre amb llimona i farigola`,
    bio: ` Recepta fàcil i pràctica. Es pot menjar fred.` ,
  ...
  {
    nombre: `Cigrons amb refregit de ceba i pebre roig`,
    bio: ` Per sortir del pas i menjar proteína vegetal.` ,
    ingredientes: ` 400 g de cigrons (poden ser de pot, així és més ràpid); Un casc de ceba;  Un full de llorer;  Una ceba tendra;  Una culleradeta de pebre vermell picant;  Una culleradeta de pebre vermell dolç;  Una culleradeta de pols de tomàquet (opcional, però així estan més suaus)`,
    // tslint:disable-next-line: max-line-length
  ...
  {
    nombre: `Pollastre Rostit a l'Ajillo amb Llimona`,
    bio: ` Recepta fàcil i pràctica.` ,
  ...
  {
    nombre: `Vinagreta de pernil`,
    bio: ` Vinagreta de pernil que es conserva setmanes a la nevera` ,
    ingredientes: `300 g de pernil salat o ibéric (jo el faig amb ibéric); 150 g de tomàquet fresc de ramallet (de sucar); 200 g d'oli d'oliva; 100 g de vinagre de vi (jo el faig amb vinagre-módena); 2 o 3 grans d'all; Orenga al gust; 2 fulles de llorer`,
